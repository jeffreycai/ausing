...
<div id="page-wrapper">
  ...
  <div class="row" style="margin-top: 15px;">
        <?php echo Message::renderMessages(); ?>
          ...
          <div class="col-xs-6 col-md-4 col-lg-3" style="padding-bottom: 15px;" id="<?php echo "deal-" . $i ?>">
            <div style="position: relative; margin: 0 0 10px 0;">
              <img src="<?php echo $deal->img ?>" class="img-responsive" />
            </div>
            <div style="height: 2.5em; line-height: 1em;">
              <a href="<?php echo $deal->url ?>" target="_blank"><?php echo $deal->title; ?></a>
            </div>
            <div style="color: #EB666B;">
              <?php echo $deal->price; ?>
            </div>
